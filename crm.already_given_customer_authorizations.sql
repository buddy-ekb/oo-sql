CREATE OR REPLACE FUNCTION crm.already_given_customer_authorizations(eindkomst yes_no_unknown, lønsum yes_no_unknown, selvangivelse_selskaber yes_no_unknown, udbytte yes_no_unknown, selvangivelse_personlig yes_no_unknown, skattekonto yes_no_unknown, moms yes_no_unknown) RETURNS varchar[] LANGUAGE sql IMMUTABLE STRICT AS $body$
SELECT
